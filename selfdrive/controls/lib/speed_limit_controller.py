...
_LIMIT_PERC_OFFSET_V = [0.0, 0.17, 0.2,  0.2, 0.17, 0.16, 0.17]  # 25, 35, 48, 60, 65, 75, 82 mph
_LIMIT_PERC_OFFSET_BP = [11.0, 13.4, 20.1, 22.3, 24.58, 29.0, 31.3]  # 25, 30, 40 50, 55, 65, 70 mph
